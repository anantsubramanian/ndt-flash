...
package  {
	...
	public class UserAgentTools {
		...
		/*
			...
			This class is use to obtain information about who is accessing
			a web-server.
			
			When a web browser accesses a web-server, it usually transmits
			a "User-Agent" string.
			This is expected to include the name and versions of the browser
			and the underlying Operating System. Though the information
			inside a user-agent string is not restricted to these alone,
			currently NDT uses this to get Browser OS only.
		...
		*/
		...
		public static function getFirstVersionNumber(a_userAgent:String, a_position:int, numDigits:int):String {
		...
		public static function getVersionNumber(a_userAgent:String, a_position:int):String {
			if(a_position < 0)
				return "";
