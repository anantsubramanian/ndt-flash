...
package  {
	...
	public class TestC2S {
		...
		*/
		...
		private var _iPktsRem:int;	// indicating the number of packets not sent from the last
									// outSocket send operation
		...
		*/
		...
		/*
			...
			Function triggered when the test socket connection
		...
		*/
		...
		/*
			Function that handles the initial test prepare message
			sent by the server. It fills the buffer ByteArray with
			data and creates a new Socket object to connect to the
		...
		*/
		...
		/*
			...
			message to indicate to the client that it should start
			sending data.
		*/
		...
		/*
			Function that is called repeatedly to write data
			through the Socket connection to the server.
			@Also_See: onOutProgress
		*/
		...
		/*
			Function that is called to calculate the throughput once
			all data that can be sent in the time duration _dTime has
		...
		*/
		...
		private function calculateThroughput():void {
			...
			// number of packets sent = (no. of iterations) * (buffer size) + (bytes sent from last message if any)
		...
		/*
			Function that receives the server computed value of the
			throughput and stores it in the corresponding field.
		*/
		...
		/*
			Function that adds the results to the output to be displayed
		...
		*/
		...
		public function TestC2S(socket:Socket, paramProtoObj:Protocol, host:String, callerObject:MainFrame) {
			// constructor code
